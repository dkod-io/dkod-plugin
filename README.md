...
|-----------|-------------|
| **MCP Server** | 13 tools — `dk_connect`, `dk_context`, `dk_file_read`, `dk_file_write`, `dk_file_list`, `dk_submit`, `dk_verify`, `dk_approve`, `dk_resolve`, `dk_merge`, `dk_push`, `dk_status`, `dk_watch` |
